...
public class AdminProductController {
     ...
     public ResponseEntity<ApiResponse<Page<ProductResponse>>> getProductsByCategoryId(
        ...
        public ResponseEntity<ApiResponse<ProductResponse>> addProduct(@PathVariable Long id, @RequestBody ProductAddRequest productAddRequest) {
           ApiResponse<ProductResponse> apiResponse = productService.addProduct(productAddRequest, id);
           return ResponseEntity.status(HttpStatus.CREATED).body(apiResponse);
        }
       @PutMapping("update/{id}")
       @PreAuthorize("hasAuthority('ADMIN')")
        public ResponseEntity<ApiResponse<ProductResponse>> updateProduct(@RequestBody ProductAddRequest productAddRequest, @PathVariable Long id){
           ApiResponse<ProductResponse> apiResponse = productService.updateCategory(productAddRequest, id);
